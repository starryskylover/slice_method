void jet_gamma(){
  ...
  TH1D *hist_CR1_bac_1=(file_3->Get<TH1D>("hist1"));
  TH1D *hist_CR1_bac_2=(file_3->Get<TH1D>("hist2"));
  TH1D *hist_CR1_bac_3=(file_3->Get<TH1D>("hist3"));
  TH1D *hist_CR1_bac_4=(file_3->Get<TH1D>("hist4"));
  TH1D *hist_CR1_bac_5=(file_3->Get<TH1D>("hist5"));

  // hist_CR1_bac_1->Draw();
  
  TH1D *hist_CR1_data_1=(file_1->Get<TH1D>("hist1"));
  TH1D *hist_CR1_data_2=(file_1->Get<TH1D>("hist2"));
  TH1D *hist_CR1_data_3=(file_1->Get<TH1D>("hist3"));
  TH1D *hist_CR1_data_4=(file_1->Get<TH1D>("hist4"));
  TH1D *hist_CR1_data_5=(file_1->Get<TH1D>("hist5"));

  TH1D *hist_CR1_sig_1=(file_2->Get<TH1D>("hist1"));
  TH1D *hist_CR1_sig_2=(file_2->Get<TH1D>("hist2"));
  TH1D *hist_CR1_sig_3=(file_2->Get<TH1D>("hist3"));
  TH1D *hist_CR1_sig_4=(file_2->Get<TH1D>("hist4"));
  TH1D *hist_CR1_sig_5=(file_2->Get<TH1D>("hist5"));
  ...
  // hist_CR1_bac_5 = dynamic_cast<TH1D*>(hist_CR1_bac_5->Rebin(nbins,"hist5",xbins));
    ...
    hist_CR1_jetgamma_5->Add(hist_CR1_bac_5,-1);
     ...
     TFile *file_CR1 = new TFile ("CR1_jetgamma.root","RECREATE");
